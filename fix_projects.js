...
const topFiles = [
  'this-is-jecrc-ep-0.mp4',
  'yeh-dil.mp4',
  'aakhiri-chai.mp4',
  'home-away.mp4',
  'the-hype-is-real.mp4'
];

const restFiles = files.filter(f => !topFiles.includes(f));
const allFiles = [...topFiles, ...restFiles];
...
console.log('Fixed projects.ts syntax!');
